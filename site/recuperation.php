...
<head>
    ...
    <title>Recuperar senha | A Silent Place</title>
...
<body>
    <header>
        ...
        <div class="p-4 text-center" style="background-color: #fff5ee">
            <h1 id="start" class="my-1 h3">Resetar senha</h1>
        </div>
    </header>
    <section>
        <!-- Main layout -->
                        ...
                        <div class="mainCard">
                            ...
                            <div class="card-body">
                                ...
                                <?php
                                    ...
                                    unset($_GET["empty_field"]);
                                ?>
                                <?php
                                    if (isset($_GET["recuperation_email"])) {
                                        if ($_GET["recuperation_email"] === "success") {
                                            echo "<h3 class='successMessage'>Link enviado com sucesso, verifique seu email (Este link não dura para sempre!)</h3>";
                                            echo "<p>Um email será enviado para você contendo link e instruções em como resetar sua senha</p>";
                                        }
                                    }
                                ?>
                                <form action="php/recuperation.php" class="form" method="POST">
                                    ...
                                    <div class="d-grid">
                                        <button type="submit" name="recuperation" class="btn btn-primary loginBtn">Enviar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
