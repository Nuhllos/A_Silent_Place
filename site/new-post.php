...
<head>
    ...
    <title>Criar Post | A Silent Place</title>
...
<body>
    <header>
        ...
        <div class="p-4 text-center" style="background-color: #fff5ee">
            <h1 id="start" class="my-1 h3">Criar Artigo</h1>
        </div>
    </header>
    <section>
        <!-- Main layout -->
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        ...
                        <div class="mainCard">
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                <form action="php/new-post.php" class="form" method="POST">
                                    <div class="mb-3">
                                        <label for="op-name" class="form-label">Nome do autor</label>
                                        <input type="text" name="op-name" id="op-name" class="form-control op-name" placeholder="Digite o nome do autor do artigo">
                                    </div>
                                    <div class="mb-3">
                                        <label for="op-about" class="form-label">Sobre o autor</label>
                                        <textarea type="text" name="op-about" id="op-about" class="form-control op-about" placeholder="Sobre o autor do artigo"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="op-facebook" class="form-label">Facebook do autor</label>
                                        <input type="text" name="op-facebook" id="op-facebook" class="form-control op-facebook" placeholder="Digite o facebook do autor do artigo (digite '#!' para deixar em branco)">
                                    </div>
                                    <div class="mb-3">
                                        <label for="op-twitter" class="form-label">Twitter do autor</label>
                                        <input type="text" name="op-twitter" id="op-twitter" class="form-control op-twitter" placeholder="Digite o twitter do autor do artigo (digite '#!' para deixar em branco)">
                                    </div>
                                    <div class="mb-3">
                                        <label for="op-instagram" class="form-label">Instagram do autor</label>
                                        <input type="text" name="op-instagram" id="op-instagram" class="form-control op-instagram" placeholder="Digite o instagram autor do artigo (digite '#!' para deixar em branco)">
                                    </div>
                                    <div class="mb-3">
                                        <label for="title" class="form-label">Título do artigo</label>
                                        <input type="text" name="title" id="title" class="form-control title" placeholder="Digite o título do artigo">
                                    </div>
                                    <div class="mb-3">
                                        <label for="image" class="form-label">Imagem do artigo</label>
                                        <input type="text" name="image" id="image" class="form-control image" placeholder="Digite a URL da imagem do artigo">
                                    </div>
                                    <div class="mb-3">
                                        <label for="title-subtitle" class="form-label">Subtítulo do artigo</label>
                                        <input type="text" name="title-subtitle" id="title-subtitle" class="form-control title-subtitle" placeholder="Digite o subtítulo do artigo">
                                    </div>
                                    <div class="mb-3">
                                        <label for="card-subtitle" class="form-label">Subtítulo do card</label>
                                        <input type="text" name="card-subtitle" id="card-subtitle" class="form-control card-subtitle" placeholder="Digite o subtítulo do card">
                                    </div>
                                    <div class="mb-3">
                                        <label for="content" class="form-label">Conteúdo</label>
                                        <textarea type="text" name="content" id="content" class="form-control content" placeholder="Conteúdo do artigo (note que a formatação deve ser feita conforme os padrões do HTML. Todo texto deve conter a tag <p></p>)" rows="5"></textarea>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-primary loginBtn">Criar</button>
                                    </div>
                                </form>
                            </div>
                        </div>
