                    ...
                    <div class="col-lg-4 col-md-8 col-sm-8">
                        ...
                        <div class="mainCard">
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                    <h3 class="mb-5 errorMessage">O usuário escolhido já existe. Informe outro e tente novamente</h3>
                                <?php
                                    endif;
                                ...
                                <form action="php/signup.php" class="form" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <a href="signin.php" class="sucessLink">Já possui uma conta? Entre!</a>
                                    </div>
                                    <div class="d-grid">
