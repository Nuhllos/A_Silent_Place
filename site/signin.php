...
<head>
    ...
    <title>Entrar | A Silent Place</title>
...
<body>
    <header>
        ...
        <div class="p-4 text-center" style="background-color: #fff5ee">
            <h1 id="start" class="my-1 h3">Entrar</h1>
        </div>
    </header>
    <section>
        <!-- Main layout -->
                    ...
                    <div class="col-lg-4 col-md-8 col-sm-8">
                        ...
                        <div class="mainCard">
                            <div class="card-title text-center border-bottom">
                                <h3 class="p-3">Entrar</h3>
                            </div>
                            <div class="card-body">
                                <?php
                                    if (isset($_SESSION["unauthenticated"])):
                                ?>
                                    <h3 class="mb-5 errorMessage">Erro: usuário ou senha inválidos</h3>
                                <?php
                                    endif;
                                ...
                                ?>
                                    <h3 class="mb-5 successMessage">Senha atualizada com sucesso</h3>
                                <?php
                                    endif;
                                    unset($_SESSION["empty_field"]);
                                ?>
                                <form action="php/signin.php" class="form" method="POST">
                                    <div class="mb-4">
                                        <label for="user" class="form-label">Usuário</label>
                                        <input type="text" name="user" id="user" class="form-control user" placeholder="Digite o usuário">
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-3">
                                        <a href="signup.php#start" class="sucessLink">Não possui uma conta? Cadastre-se!</a>
                                    </div>
                                    <div class="mb-3">
                                        <a href="recuperation.php#start" class="sucessLink">Esqueceu sua senha? Resetar minha senha</a>
                                    </div>
                                    <div class="d-grid">
